            ...
            <div class="form-group row">
                ...
                <div class="col-auto">
                    <select class="form-control" id="select" onchange="changeSearchName(this);">
                        <option name="name" selected><fmt:message key="message.select.name"/></option>
                        <option name="author" ${author != null ? 'selected' : ''}><fmt:message key="message.select.author"/></option>
                        <option name="attribute" ${attribute != null ? 'selected' : ''}><fmt:message key="message.select.attribute"/></option>
                    </select>
                </div>
                <div class="col-sm-3">
                    <input id="search" class="form-control" name="name" type="text" value="${name != null ? name : author != null ? author : attribute != null ? attribute : ''}" required>
                </div>
                <div class="col-sm-2">
                        ...
                        <td>
                            <c:choose>
                                <c:when test="${book.ownedDate == null}">
                                    <a href="take/${book.id}"><strong><fmt:message key="message.book.take"/></strong></a>
                                </c:when>

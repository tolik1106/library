...
public class AdminService {
    ...
    public AdminService(AuthorDao authorDAO, BookDao bookDAO, AttributeDao attributeDAO, UserDao userDAO, BookAuthorDAO bookAuthorDAO, BookAttributeDAO bookAttributeDAO) {
